...
import com.kaandradec.focustimer.core.Constants.Companion.ONE_HOUR_IN_MIN
...
class HomeScreenViewModel @Inject constructor() : ViewModel() {
    ...
    // Desde dentro de el ViewModel el estado se puede alterar, pero desde fuera no.
    val timerValueState = _timerValue // Exponemos el estado (PRIVATE set PUBLIC get)
    ...
    fun onStartTimer() {
        // viewModelScope: Esta logica solo se ejecuta mientras el ViewModel viva/activo.
        // Si se llama a ViewModel.onCleared() automaticamente se limpia y los estados se reinician.
        viewModelScope.launch {
            timer = object : CountDownTimer(
                _timerValue.value, // Valor que tiene en ese momento el timer
                ONE_SEC_IN_MILLIS // Cada cuanto tiempo se ejecuta el onTick
            ) {
